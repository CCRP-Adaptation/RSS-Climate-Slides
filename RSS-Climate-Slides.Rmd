...
OutDir <- paste0("E:/RCF_2024/", SiteID, ".zip/", SiteID)

Park_CF_Dir <- paste0("E:/RCF_2024/", SiteID, ".zip/", SiteID)

HistDir <- paste0("E:/RCF_2024/", SiteID, ".zip/", SiteID, "/input-data")
...
![**Figure 1.** Historical (gray) and future projections (`r color.names[1]` and `r color.names[2]` lines) for annual mean temperature and precipitation in `r SiteID`. The lines running through the time series is the 10-year running average. Gray shaded area represents the future time period used to average future changes from the historical baseline. See Runyon et al. (2024) for details.](%60r%20fig%60)
